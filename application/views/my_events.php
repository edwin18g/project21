    			...
    			<table class="table table-striped table-hover">
    				...
    				<tbody>
    					...
    					<tr class="my-be-tr">
    						...
    						<td><?php echo $val->payment_type == 'locally' ? lang('b_bookings_payment_type_lly') : ($val->payment_type == 'stripe' ? lang('b_bookings_payment_type_ipe') : lang('b_bookings_payment_type_pal')); ?> (<?php echo $val->payment_status == 1 ? lang('e_bookings_payment_status_successful') : ($val->payment_status == 2 ? lang('e_bookings_payment_status_failed') : lang('e_bookings_payment_status_pending')); ?>)</td>
